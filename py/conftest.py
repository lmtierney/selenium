...
def pytest_addoption(parser):
    ...
    parser.addoption('--binary', action='store', dest='binary',
                     help='location of the browser binary')
    parser.addoption('--exec', action='store', dest='executable',
                     help='location of the service executable')
    parser.addoption('--args', action='store', dest='args',
